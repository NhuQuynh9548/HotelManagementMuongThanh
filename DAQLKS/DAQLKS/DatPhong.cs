...
namespace DAQLKS
{
    public partial class DatPhong : Form
    {
        ...
        private void btnChiTietDatPhong_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnDatPhong_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Checkbox được chọn!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information); // Kiểm tra checkbox
                this.Close();
        ...
        private void dataGridViewDSDatPhong_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow row = dataGridViewDSDatPhong.SelectedRows[0];
            string maChiTietDP = row.Cells[0].Value.ToString();
