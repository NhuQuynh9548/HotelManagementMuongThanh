...
namespace DAQLKS
{
    public partial class NhanPhong : Form
    {
        ...
        private void NhanPhong_Load_1(object sender, EventArgs e)
        {
            Load_comboPhong();
            Load_GV();
        }
        ...
        private void btnLayPhong_Click_1(object sender, EventArgs e)
        {
            if (cbLoaiPhong.Text != "")
            {
        ...
        private void btnSreach_Click_1(object sender, EventArgs e)
        {
